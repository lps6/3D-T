...
|----------|---------------------|--------|
| [Cap. 01](#cap01_criacao_personagem/cap01_criacao_personagem) — Sentinelas do Solstício | Despertar Planetário (poderes por marcos emocionais) | Ordem das Sentinelas |
| [Cap. 02](#cap02_a_academia/cap02_a_academia) — Guardiãs de Coleção | Artefatos Arcanamente Independentes (coleção expansível) | Prática das Guardiãs |
| [Cap. 03](#cap03_as_casas/cap03_as_casas) — Parceiras de Ressonância | Subsistema Poder de Amizade (mecânicas coletivas) | Sistema de Sintonia |
| [Cap. 04](#cap04_professores_npcs/cap04_professores_npcs) — Cavaleiras do Vórtice | Cristais de Vontade (energia por convicção) | Ordem das Cavaleiras |
...
**Efeito padrão:** Ganho em todos os testes do **domínio central** do personagem (definido na criação)
**Frequência:** uma vez por cena. Depois que o Estado Transformado termina numa cena, não pode ser reativado na mesma cena

**O domínio central** é definido na criação do personagem e deve ser específico:
- Correto: "combate físico corpo-a-corpo", "análise e diagnóstico arcano", "cura de aliados"
- Incorreto: "todos os testes", "qualquer coisa mágica"
...
- Duração: 1 cena
- Frequência: 1×/sessão (em vez de 1×/cena)
- Efeito: scale Kami para os efeitos específicos do Marco
...
- Fora do Estado: pode detectar artefatos Perto com teste passivo H vs 2
...
- Poder de Amizade ([Cap. 03](#cap03_as_casas/cap03_as_casas), Parceiras): pode ser adotado por qualquer PC independente da prática base. É opt-in — o jogador decide na criação se quer participar do subsistema coletivo
- Artefatos Arcanamente Independentes ([Cap. 02](#cap02_a_academia/cap02_a_academia), Guardiãs): qualquer grupo pode ter a missão de captura mesmo que os poderes individuais venham de outra prática
- Cristais de Vontade ([Cap. 04](#cap04_professores_npcs/cap04_professores_npcs), Cavaleiras): pode ser adotado por qualquer PC com Crença Central definida, independente de qual prática define seus outros poderes
...
## Recomendações por Tipo de Mesa
...
| Termo | Definição |
|-------|-----------|
| Estado Transformado | Estado ativo que concede Ganho no domínio central, 1 PM, 1×/cena |
| Despertar Planetário | Evolução do Estado Transformado para escala Kami; 1×/sessão; desbloqueado por Marco |
