...
O [Capítulo 3](#cap03_as_casas/cap03_as_casas) do Livro-Base (*As Casas*) inclui um exemplo completo de fundação de grêmio — e o exemplo escolhido é **exatamente** a filosofia deste livro:
...
O **Grêmio Prisma** é a tradução institucional de Estrelas & Cristais:

| Aspecto | Grêmio Prisma |
|---------|---------------|
| **Moralidade mágica** | *Magia nasce dos laços entre as pessoas. Quanto mais forte o vínculo, mais poderoso o feitiço.* |
| **Cores** | Arco-íris (cada membro contribui sua "cor") |
...
O sistema de Pilar das Cavaleiras ([Cap. 04](#cap04_professores_npcs/cap04_professores_npcs)) — onde uma pessoa sustenta a realidade de um mundo inteiro através de força de vontade — sugere uma tradição mágica que nenhuma escola existente cobre:

### Escola do Pilar (Conceito)

**Localização:** Sem localização fixa. A escola existe onde o Pilar atual está.
...
**Relação com AAV:** O sistema de Pilar para Wynna ([Cap. 04](#cap04_professores_npcs/cap04_professores_npcs) deste livro) já sugere que a reitora pode estar funcionando como Pilar da Arca. Se a Escola do Pilar existe, Wynna é uma ex-aluna — e ninguém sabe.
...
## O MagiDerby das Estrelas

Se o Grêmio Prisma for fundado na campanha, sua primeira participação no MagiDerby é um evento narrativo:

**Estilo:** Transformação como estratégia de jogo. Cada membro muda de forma durante a partida, confundindo adversários. Nenhuma posição fixa — todos atacam, todos defendem, todos brilham.

**Reação dos outros grêmios:**
- Égide: *"Brilhante. Mas forma sem disciplina não sustenta."*
- Coroa: *"Imprevisível. O que é preocupante. E fascinante."*
- Aurora: *"ISSO! MAIS DISSO!"*
- Obsidiana: *"Vamos ver se funciona na segunda partida, quando já sabemos o truque."*
- Monsoon: *"Finalmente, alguém entendeu que o espetáculo É o jogo."*
...
3. **O Derby e o Despertar** (aventuras dos Caps. 05 e 07) são perfeitos para arco de fundação do Prisma — o grupo se prova no campo e no combate antes de formalizar.

---

*Este apêndice mapeia o conteúdo do Livro 1 aos grêmios e escolas da Academia Arcana Victory. O Grêmio Prisma já existe como exemplo no [Cap. 03](#cap03_as_casas/cap03_as_casas) do Livro-Base — este livro dá a ele substância.*
