...
O [Capítulo 3](../../Livro/cap03_as_casas.md) do Livro-Base (*As Casas*) inclui um exemplo completo de fundação de grêmio — e o exemplo escolhido é **exatamente** a filosofia deste livro:
...
O sistema de Pilar das Cavaleiras ([Cap. 04](cap04_cavaleiras_do_vortice.md)) — onde uma pessoa sustenta a realidade de um mundo inteiro através de força de vontade — sugere uma tradição mágica que nenhuma escola existente cobre:
...
**Relação com AAV:** O sistema de Pilar para Wynna ([Cap. 04](cap04_cavaleiras_do_vortice.md) deste livro) já sugere que a reitora pode estar funcionando como Pilar da Arca. Se a Escola do Pilar existe, Wynna é uma ex-aluna — e ninguém sabe.
...
*Este apêndice mapeia o conteúdo do Livro 1 aos grêmios e escolas da Academia Arcana Victory. O Grêmio Prisma já existe como exemplo no [Cap. 03](../../Livro/cap03_as_casas.md) do Livro-Base — este livro dá a ele substância.*
