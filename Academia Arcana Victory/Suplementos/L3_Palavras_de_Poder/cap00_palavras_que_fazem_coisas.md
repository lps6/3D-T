# Capítulo 0 — Palavras que Fazem Coisas

> *"A Academia ensina feitiços como receitas: ingrediente, procedimento, resultado. Mas há uma tradição mais antiga que trata magia como linguística: se você entende o que algo realmente é — não o que faz, não para que serve, mas o que É — então pode comandá-lo. Não por força. Por reconhecimento."*
> — Professora Idris Salib, aula inaugural de Teoria dos Nomes, 3º Ano

---

## O Que Este Livro Cobre

Este é o livro da magia-como-compreensão. Enquanto outros livros da linha tratam magia como transformação (L1), sobrevivência (L2), herança (L4) ou rebelião (L5), aqui a premissa é diferente: **poder é conhecimento aplicado**. Entender algo completamente — seu nome, sua natureza, suas leis internas — é ter autoridade sobre esse algo.
...
Cada livro desta linha tem uma pergunta. A deste é:

> **O que você está disposto a entender — e o que esse entendimento vai custar?**

A magia de compreensão não é gratuita. Nas três tradições deste livro, o preço escala com a profundidade:
...
Escolha **uma** das três tradições como sistema mágico da sua campanha e ignore as outras. Use os NPCs e kits daquela tradição. A aventura ([Cap. 05](#cap05_vida_estudantil/cap05_vida_estudantil)) funciona com qualquer das três.
...
Se você não quer nenhum sistema de nomeação e só quer ferramentas para calibrar sua própria magia, vá direto ao [Cap. 04](#cap04_professores_npcs/cap04_professores_npcs). As Três Leis de Sanderson funcionam independentemente de tudo o mais neste livro.

---

## O Framework Unificado: Compreensão como Mecânica

Independentemente da tradição escolhida, o princípio mecânico deste livro é:

> **Quanto mais um personagem compreende algo, mais poder tem sobre esse algo — e mais vulnerável fica ao usá-lo.**

Isso se traduz em três escalas paralelas:
...
| 4 | Compreensão total | Nome do Vento | Proficiência 5 (fundamentais + Proibidas) | Nome próprio; Compulsão de entidades |
...
| 4 | Risco de morte ou loucura | 10 PV + morte possível | Débito 5 = Nome vulnerável |
...
|-------|---------------|
| 1 | Nada — seguro |
| 2 | Outros percebem que você está usando magia de compreensão |
| 3 | Entidades poderosas sentem sua investigação e podem responder |
| 4 | Seu próprio nome fica exposto; o mundo cobra o equilíbrio |

---

## Vocabulário Deste Livro

Para evitar confusão entre termos de tradições diferentes:
...
| **Soft Magic** | T4 | Sistema com limites impressionistas, resultado por intenção |

---

## Sessão Zero para Este Livro
...
3. **Dragões?** Se sim, o Vínculo Dragão ([Cap. 02](#cap02_a_academia/cap02_a_academia)) muda a campanha inteira. O dragão é personagem — não montaria. A mesa está pronta para interpretar dois papéis?

4. **Um sistema ou três?** A decisão mais importante. O [Cap. 00](#cap00_palavras_que_fazem_coisas/cap00_palavras_que_fazem_coisas) dá as opções; a mesa decide.

---

*Próximo: [Cap. 01](#cap01_criacao_personagem/cap01_criacao_personagem) — A Universidade de Saleth (Simpatia, Alar, e Nomeação avançada).*
