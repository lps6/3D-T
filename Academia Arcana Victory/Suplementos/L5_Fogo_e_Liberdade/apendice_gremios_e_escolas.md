...
|-----------|----------|------|-------------|
| Cidade de Lutharin | [Cap. 01](#cap01_criacao_personagem/cap01_criacao_personagem) | Metrópole com hierarquia arcana pós-revolução | Norte do continente; maior centro de Metalurgia Arcana |
| Escola do Covil da Floresta Convergente | [Cap. 02](#cap02_a_academia/cap02_a_academia) | Escola mágica em floresta densa; dividida entre Trilha Única e Bile livre | Sul de Vallindra, floresta de vegetação arcana |
| Escolas das Quatro Formas | [Cap. 03](#cap03_as_casas/cap03_as_casas) | Quatro academias elementais distintas; relação diplomática tensa entre si e com a Victory | Dispersas no continente por elemento (veja abaixo) |
...
- **Reputação de Classe** — instância do sistema de Reputação Faccional ([Cap. 05](#cap05_vida_estudantil/cap05_vida_estudantil)); eixos Legitimidade e Cred

**Conexões AAV:** ganchos cruzam com V3ctor1us (registros genealógicos), a Reitora Valdris (filial parceira em Lutharin), e a mecânica de Reputação Faccional ([Cap. 05](#cap05_vida_estudantil/cap05_vida_estudantil)).
...
- **Palisman** — extensão de [Cap. 06](#cap06_mecanicas/cap06_mecanicas) (Familiares) para familiar-objeto; ativo/inativo; trauma narrativo se objeto destruído

**Conexões AAV:** ganchos cruzam com V3ctor1us (avaliação de aptidão que retorna erro), a Reitora Valdris (decisão de expulsão silenciosa), e o [Cap. 05](#cap05_vida_estudantil/cap05_vida_estudantil) (Reputação Faccional para status Irregular).
...
|----------|----------|--------------|
| Metalurgia de Ignição (8 metais) | [Cap. 01](#cap01_criacao_personagem/cap01_criacao_personagem) | Média — Reserva de Metal separada de PM |
| Metalurgia de Armazenamento | [Cap. 01](#cap01_criacao_personagem/cap01_criacao_personagem) | Alta — custo imediato + ganho diferido |
| Metalurgia de Transferência | [Cap. 01](#cap01_criacao_personagem/cap01_criacao_personagem) (Mestre) | Alta — conteúdo pesado; requer ferramentas de consentimento |
| Reputação de Classe | [Cap. 01](#cap01_criacao_personagem/cap01_criacao_personagem) | Baixa — instância de [Cap. 05](#cap05_vida_estudantil/cap05_vida_estudantil) |
| Regra da Trilha Única | [Cap. 02](#cap02_a_academia/cap02_a_academia) | Baixa — subsistema de campanha on/off |
| Kit Glifista | [Cap. 02](#cap02_a_academia/cap02_a_academia) | Média — preparação prévia + combinações |
| Palisman | [Cap. 02](#cap02_a_academia/cap02_a_academia) | Baixa — extensão de [Cap. 06](#cap06_mecanicas/cap06_mecanicas) (Familiares) |
| Marcadores de Chi | [Cap. 03](#cap03_as_casas/cap03_as_casas) | Média — rastreamento por elemento |
| Estado de Equilíbrio | [Cap. 03](#cap03_as_casas/cap03_as_casas) | Alta — um PC específico; condicional narrativa |
| Reputação Faccional | [Cap. 05](#cap05_vida_estudantil/cap05_vida_estudantil) | Alta — cola de todos os sistemas do livro |
...
| Reputação de Classe | [Cap. 05](#cap05_vida_estudantil/cap05_vida_estudantil) (Reputação Faccional) | É instância direta; use o [Cap. 05](#cap05_vida_estudantil/cap05_vida_estudantil) como base |
| Palisman | [Cap. 06](#cap06_mecanicas/cap06_mecanicas) (Familiares) (Sistema de Familiar) | Extensão do sistema; usar as regras de [Cap. 06](#cap06_mecanicas/cap06_mecanicas) (Familiares) como base |
