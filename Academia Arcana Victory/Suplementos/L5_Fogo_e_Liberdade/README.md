...
| # | Título | Conteúdo |
|---|--------|----------|
| [Cap. 00](cap00_introducao.md) | [A Revolução na Mesa](cap00_a_revolucao_na_mesa.md) | Guia de tom + Framework de conflito sistêmico |
| [Cap. 01](cap01_criacao_personagem.md) | [A Era dos Metais](cap01_a_era_dos_metais.md) | Cidade de Lutharin; Metalurgia Arcana; classes e revolução incompleta |
| [Cap. 02](cap02_a_academia.md) | [O Grêmio Raízes](cap02_a_bruxa_coruja.md) | Grêmio Raízes da Floresta Convergente; Glifomagia; Trilha Única vs. Bile livre; filiação dupla com a Academia |
| [Cap. 03](cap03_as_casas.md) | [As Escolas das Quatro Formas](cap03_quatro_nacoes.md) | Quatro academias elementais; Marcadores de Chi; a guerra de oitenta anos |
| [Cap. 04](cap04_professores_npcs.md) | [Caldeira: Férias Arcanas](cap04_caldeira.md) | Campanha em cidade aberta — o sistema com número de protocolo |
| [Cap. 05](cap05_vida_estudantil.md) | [Reputação Faccional](cap05_reputacao_faccional.md) | Mecânica unificada de Legitimidade e Cred |
| [Cap. 06](cap06_mecanicas.md) | [O Manifesto](cap06_o_manifesto.md) | Aventura de introdução: 2 sessões, sem contexto prévio necessário |
...
**Se você quer usar só o sistema mecânico:** o [Cap. 05](cap05_vida_estudantil.md) (Reputação Faccional) e o [Cap. 00](cap00_introducao.md) (Framework de conflito) são suficientes para qualquer campanha com elemento político — independente de usar Lutharin, o Covil, ou as Quatro Formas.

---

## Mecânica Unificada

A mecânica central do livro está no [Cap. 05](cap05_vida_estudantil.md), mas a versão resumida: cada personagem e cada facção tem uma posição em dois eixos — **Legitimidade** (quanto o sistema institucional confia neles) e **Cred** (quanto as comunidades extra-institucionais confiam neles). As ações dos PJs movem essas posições de formas que nunca são totalmente reversíveis.

Os três sistemas introduzidos nos caps 01–03 — a Reputação de Classe de Lutharin, o status de Fora-da-Trilha do Covil, e os Marcadores de Chi das Quatro Formas — são todos instâncias desta mecânica base. Use o [Cap. 05](cap05_vida_estudantil.md) como cola: leia antes de introduzir qualquer subsistema dos outros capítulos para economizar horas de reconciliação de regras.
...
|-----|--------|-------|--------------|
| Mestre Aldric | Lutharin ([Cap. 01](cap01_criacao_personagem.md)) | Autoridade pedagógica | O homem que ensina como usar o poder sem perguntar por que o poder é distribuído assim |
...
| Davan | Quatro Formas ([Cap. 03](cap03_as_casas.md)) | Arco de questionamento | O estudante formado pela nova direção da Escola do Fogo; se aprendeu a não repetir a guerra ou a performar que aprendeu é a questão |
| Elisa Wanderley | Caldeira ([Cap. 04](cap04_professores_npcs.md)) | Antagonista-causa | Expulsa pela Academia sem explicação; construiu o Circuito não por ganância mas por prova |
| Diegão Costa | Caldeira ([Cap. 04](cap04_professores_npcs.md)) | Ponto de entrada | O rosto público de uma organização que deveria ser invisível; genuinamente acredita que está fazendo o bem |
| Mestra Kofi | Caldeira ([Cap. 04](cap04_professores_npcs.md)) | Aliada comunitária | Líder da Escola Livre da Rua 7; ajuda os PJs se confiar neles; desconfia de academia formal por padrão |
...
**Use o [Cap. 05](cap05_vida_estudantil.md) como cola.** Lutharin, o Covil, e as Quatro Formas são filosoficamente distintos e não devem ser misturados sem um framework que os conecte. Esse framework é a Reputação Faccional. Sem ela, você obtém três campanhas paralelas num mesmo livro.

**A aventura é a porta de entrada.** Você pode abrir o livro diretamente no [Cap. 06](cap06_mecanicas.md), jogar O Manifesto com sua mesa, e só depois ler os outros capítulos. A aventura apresenta o livro melhor que qualquer introdução.
