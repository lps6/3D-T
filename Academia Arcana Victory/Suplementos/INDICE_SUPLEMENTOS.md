...
> **Como usar este índice:** Os suplementos da Academia Arcana Victory foram consolidados em **8 Livros Temáticos** (L0–L7). Cada livro é um produto completo e autossuficiente — você não precisa de nenhum outro para jogar qualquer um deles. O livro base de 3D&T Victory é o único pré-requisito universal.
>
> Este índice detalha, para cada livro: os **capítulos**, as **influências** (franquias e suplementos-fonte consolidados), e as **mudanças relevantes** que o livro traz ao jogo — mecânicas novas, opções de personagem, escolas, grêmios, cidades e locais.
>
> Para os suplementos-fonte originais (F2.x–F4.x, S1–S6, C1–C3, T1–T4, Y1–Y3, K1, ALA, FAM1, N1) que foram consolidados nestes livros, ver `/Arquivo/`.
...
**Para quem:** Mestres que querem uma campanha com arco central de mistério cobrindo o 1º ao 3º ano e além.  
**Fontes consolidadas:** ALA (Protocolo Ala Leste), S4 (O Calouro Que Sumiu), S5 (Quando a Arca Estremece), C3 (Pós-Graduação: Os Mestres)

### Capítulos

| # | Título | Tipo | Conteúdo |
|---|--------|------|----------|
| cap00 | A Linha do Tempo | Novo | Como costurar os módulos em arco único; guia de ritmo S4 → ALA → S5 → C3 |
| cap01 | Protocolo Ala Leste | ALA | Exploração procedural da Ala Leste; sistema de incursões com tempo limitado |
| cap02 | O Calouro Que Sumiu | S4 | One-shot de 1 sessão; desaparição de Leo Bateman; revelação sobre V3ctor1us |
| cap03 | Quando a Arca Estremece | S5 | Arco de 3 sessões; crise estrutural da Academia; V3ctor1us toma decisão autônoma |
| cap04 | Pós-Graduação: Os Mestres | C3 | Campanha pós-formatura; PJs como professores com responsabilidade inversa |
| apêndice | Como Modular | Novo | Guia de uso parcial: só ALA, só S4+S5, ou arco completo |

### Mecânicas Novas

| Mecânica | Tipo | Descrição |
|----------|------|-----------|
| **Contador de Detecção** | Overlay | Nível de alerta de V3ctor1us durante exploração da Ala Leste (0–5); reseta fora da Ala |
| **Índice de Coesão** | Overlay | Estabilidade estrutural da Arca (100%→0%); ativo durante cap03 e endgame |
| **Auditoria Arcana** | Técnica | 2 PM, teste H+Saber dif. 8: identifica se sistema mágico opera conforme declarado |

### Grêmios, Escolas & Locais

| O Que | Tipo | Novidade |
|-------|------|----------|
| **Ala Leste** | Local | Área bloqueada da Academia com mapa procedural e tabelas de descoberta progressiva |
| **Perspectiva de cada grêmio** | Conteúdo | Como Égide, Coroa, Aurora, Obsidiana, Monsoon, Síntese e Memória reagem ao mistério central |
| **Brambleshire, Zawiya, Uiara, Gurukula** | Escolas externas | Como cada escola de fora vê a opacidade de V3ctor1us; ganchos de perspectiva externa |
| **Escola-Fantasma: O Protocolo** | Local/Facção | Rede clandestina de ex-alunos; mecânica exclusiva de Auditoria Arcana |
...
| Mecânica | Tipo | Descrição |
|----------|------|-----------|
| **Estado Transformado** | Base | 1 PM; dura cena inteira; Ganho em testes do domínio central do personagem |
...
| cap06 | A Noite na Biblioteca | S2 | Aventura de 1 sessão; entidade que não quer machucar mas machuca |
| cap07 | A Aula que Não Acabou | Novo | Aventura nova: prova prática sai do controle e ativa protocolo de Crisol |

### Mecânicas Novas

| Mecânica | Tipo | Descrição |
|----------|------|-----------|
| **Custo da Magia** (unificado) | Sistema | Consolida Pressão Ambiental + Fragmentação + Vício em trilha única de desgaste |
| **Pressão Ambiental** | Overlay | Marcadores de tensão acumulativa com gatilho em 5; survival horror |
| **Fragmentação** | Persistent | 4 níveis de degradação mental por uso além da capacidade emocional |
| **Vício Arcano** | Persistent | Uso excessivo de técnica específica cria compulsão; penalidade por abstinência |
| **Calibração de Escuridão** | Ferramenta | 5 dials de intensidade; o GM liga um por vez para criar pressão gradual |
...
| apêndice | Grêmios, Escolas & Nomes | Referência | Mapeamento franquia → grêmio; conexões com escolas externas |
...
| cap07 | O Torneio das Escolas | S3 | Arco de 3 sessões; competição inter-escolas de MagiDerby; investigação paralela |
| apêndice | Tabela Comparativa de Opções | Referência | Navegação de 21 kits, 7 vantagens, 7 subsistemas por paradigma de herança |

### Mecânicas Novas

| Mecânica | Tipo | Descrição |
|----------|------|-----------|
| **Sistema de Linhagem** | Framework | Traço de Linhagem + Fardo de Linhagem + Status de Herança (modulável por franquia) |
| **Herança Arcana** | Overlay | Dom Passivo automático + Marca Narrativa por divindade progenitora |
| **Glifos Arcanos** | Sistema | Inscrição corporal: permanentes, temporários, raros, proibidos; custo por nível de glifa |
| **Vínculo de Alma** | Persistent | Laço com parceiro: PV compartilhados, amplificação, telepatia; custo 3 pts |
| **Status de Facção** | Overlay | Track 1–5 por facção do Mundo Oculto; aumenta por escolhas narrativas |
| **Facções Ocultas** | Sistema | 5 sociedades secretas com Poder Oculto + Vulnerabilidade + Kit Agente Duplo |
| **11 Arquétipos Acadêmicos** | Kits | Veterano Acadêmico, Investigador de Anomalias, Herdeiro Arcano, Sombra do Campus, e mais |
...
| # | Título | Tipo | Conteúdo |
|---|--------|------|----------|
| cap00 | A Revolução na Mesa | Novo | Guia de drama político sem sermão; todos os lados com motivações válidas |
| cap01 | A Era dos Metais | F3.7 | Allomancia e Feruchemia: 16 metais com efeitos distintos; Reputação de Classe; hierarquia Nobre/Skaa |
| cap02 | A Escola da Bruxa Coruja | F4.1 | Glifomagia livre: desenhar = lançar; crítica à Trilha Única; kit Fora-da-Trilha |
| cap03 | Quatro Nações, Uma Disciplina | F4.2 | Chi Markers; 4 estilos de dobramento; Alinhamento Filosófico; disciplina corporal como magia |
| cap04 | Caldeira: Férias Arcanas | C1 | Campanha urbana de 6–8 sessões; rede de expulsos; Elisa Wanderley como antagonista moral |
| cap05 | Reputação Faccional | Novo | Sistema unificado Legitimidade × Cred; consolida os 3 sistemas políticos das franquias |
| cap06 | O Manifesto | Novo | Aventura de 2 sessões; panfleto anônimo contra V3ctor1us; duas rotas completamente distintas |

### Mecânicas Novas

| Mecânica | Tipo | Descrição |
|----------|------|-----------|
| **Reputação Faccional** | Persistent | Legitimidade × Cred em dois eixos independentes; movimentos nunca totalmente reversíveis |
| **Allomancia** | Overlay | Engolir metal → poder específico por tipo; 16 metais com efeitos distintos |
| **Glifomagia** | Overlay | Desenhar símbolo = ativar efeito; sem lista de feitiços; limitado por criatividade e tempo |
| **Chi Markers** | Overlay | Ganhos filosóficos por cena; 3 marcadores = –1 PM; reseta entre cenas |
| **Alinhamento Filosófico** | Overlay | Posição do personagem em eixo filosófico; afeta eficácia de técnicas de dobramento |
...
| # | Título | Tipo | Conteúdo |
|---|--------|------|----------|
| cap00 | Criatividade com Paredes | Novo | Framework de Magia Criativa; 3 Eixos do Caos; calibrador 1–5; jogável sem franquias |
| cap01 | Desejos e Travessuras | F4.6 | 5 Padrinhos com mecânicas individuais; Da Rules; Medidor de Necessidade; 4 tipos de Desejo |
| cap02 | Magia Dimensional | F4.7 | Essência Mágica personalizada; Grimório Familiar; 5 Categorias de Efeito; Portais dimensionais |
| cap03 | Consequência Criativa | Novo | Sistema unificado: Nível de Caos da Cena (0–8); coexistência das duas magias; 3 Configurações |
| cap04 | O Desejo Dimensional | Novo | Aventura cômica de 1–2 sessões; tabela d8 de complicações crescentes; 3 caminhos de resolução |
| apêndice | 20 Dimensões em 1 Frase | Novo | Toolkit d20 com regra imediata, perigo instantâneo e gancho de retorno por dimensão |

### Mecânicas Novas

| Mecânica | Tipo | Descrição |
|----------|------|-----------|
| **Consequência Criativa** | Sistema | Nível de Caos da Cena 0–8; quanto mais criativo o uso, mais imprevisível o resultado |
| **Essência Mágica** | Framework | Todo PC define: Aparência + Nome do Feitiço + Categoria; feitiços únicos e pessoais |
| **5 Categorias de Efeito** | Overlay | Explosivo / Controle / Transformação / Portal / Proteção; custo em PV em vez de PM |
| **Grimório Familiar** | Persistent | Livro vivo com Páginas Reveladas, Ocultas e Escritas pelo PC; progressão por uso |
| **Desejos por Sessão** | Overlay | 3→4→5 por nível de campanha; Caos Mágico acumulativo por cadeia de desejos |
| **Medidor de Necessidade** | Overlay | Escala 0–5 de necessidade emocional do afilhado; afeta disponibilidade dos Padrinhos |
| **Portais Dimensionais** | Overlay | Custo variável por destino; cooldown; tabela d6 de eventos de Vórtex |

### Grêmios, Escolas & Locais

| O Que | Tipo | Novidade |
|-------|------|----------|
| **20 Dimensões** | Novos locais | Toolkit de improvisação; cada dimensão tem física própria, perigo e regra de retorno |
| **Tribunal das Fadas** | Facção/Setting-layer | Instância reguladora dos Padrinhos; Da Rules como mecânica de restrição oficial |
| **Estudos Dimensionais** | Nova matéria | Nova disciplina da Academia; Prof. Adélio Pires como NPC recorrente |

---

## Tabela de Subsistemas (Todos os Livros)

> **Regra editorial:** Ative no máximo **3 subsistemas do tipo Persistent** ao mesmo tempo. Overlays podem ser somados livremente dentro de seu escopo de cena ou campanha.

| Subsistema | Livro | Tipo | Compatível Com |
|------------|-------|------|----------------|
| Contador de Detecção | L0 | Overlay | Todos |
| Índice de Coesão | L0 | Overlay | Todos |
| Estado Transformado | L1 | Base | Todos |
| Despertar Planetário | L1 | Persistent | Social Links (com cautela) |
| Pressão Ambiental | L2 | Overlay | Todos |
| Fragmentação | L2 | Persistent | Não com Custo da Magia unificado simultâneo |
| Débito de Equilíbrio | L3 | Persistent | Grimório (cap11 base); não com Fragmentação |
| Sistema de Linhagem | L4 | Framework | Todos — é camada narrativa, não mecânica de ação |
| Glifos Arcanos | L4 | Sistema | Não com Allomancia/Glifomagia ao mesmo tempo |
| Reputação Faccional | L5 | Persistent | Todos |
| Social Links | L6 | Persistent | Combustível Emocional (alimentam-se mutuamente) |
| Vínculos de Campanha | L6 | Persistent | Escolha entre Social Links ou Vínculos — são a mesma camada |
| Consequência Criativa | L7 | Overlay | Todos |
| Grimório Familiar | L7 | Persistent | Débito de Equilíbrio (papéis distintos — compatível) |

---

## Timeline de Campanha (Sugestão de 4 Anos)

| Quando | Livro / Capítulo | Por quê |
|--------|-----------------|---------|
| 1º Ano, 1ª sessão | L1 cap05 (Primeiro Derby) | Tutorial de MagiDerby |
| 1º Ano, mid | Qualquer cap de franquia (L1–L7) | Estabelecer tom da campanha |
| 1º Ano, final | L6 cap04 (Festival de Inverno) | Consolidar laços antes do 2º ano |
| Férias Ano 1–2 | L5 cap04 (Caldeira) | Mundo fora da escola; antagonista moral |
| 2º Ano | L3 cap05 ou L2 cap06 | Primeiro mistério real |
| 2º Ano, final | L0 cap02 (O Calouro Que Sumiu) | Semente da dúvida sobre V3ctor1us |
| 2º–3º Ano | L0 cap01 (Protocolo Ala Leste) | Investigação do mistério central |
| 3º Ano, 1ª metade | L4 cap06 (Brambleshire) ou L7 cap04 | Intercâmbio ou respiro cômico |
| 3º Ano, final | L0 cap03 (Quando a Arca Estremece) | Crise; ponto de não-retorno |
| Pós-formatura | L0 cap04 (Pós-Graduação: Os Mestres) | Epílogo; PJs como professores |

---

*Última atualização: Março 2026 — v2.0*  
*Suplementos-fonte arquivados em `/Arquivo/`. Estrutura consolidada completa (L0–L7).*
