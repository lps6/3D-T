# Apêndice — Tabela Comparativa de Opções de Personagem

> *"Vinte e uma opções de kit. Sete vantagens exclusivas. Sete subsistemas. Se você está lendo isto, é porque precisava de um mapa. Aqui está."*

---

Este apêndice existe porque Sangue & Legado é o livro com o **maior volume de opções de personagem** da linha Academia Arcana Victory. Três franquias, onze arquétipos, cinco sociedades secretas, três kits de escola visitante, e um framework genérico de herança. Sem guia, o risco é paralisia.

**Como usar:** leia a tabela do tipo que interessa (kits, vantagens, ou subsistemas), filtre pela coluna de paradigma se sua campanha usa um específico, e escolha.

---

## Tabela 1: Kits e Arquétipos

### Kits de Franquia (mecânicas novas)
...
## Tabela 3: Subsistemas Mecânicos
...
### Se sua campanha quer herança sem franquia:
- **Kit recomendado:** Herdeiro Arcano + qualquer outro que combine com o conceito
- **Subsistema:** Sistema de Legado (cap00) — use apenas Traço + Fardo para começar
- **Adição:** Membro de Sociedade Secreta conecta herança a intriga institucional

### Se sua campanha é inter-escolas:
- **Campanha longa (8–12 sessões):** [Cap06](cap06_a_outra_escola_brambleshire.md) (Brambleshire) com kits Arcanist Warden / Thornblade / Lorekeep
- **Arco curto (3 sessões):** [Cap07](cap07_o_torneio_das_escolas.md) (Torneio) — não requer kit específico

---

## Contagem Final de Opções
...
## Combinações Proibidas (ou pelo menos não-recomendadas)

| Combinação | Por Que Não |
|-----------|-----------|
