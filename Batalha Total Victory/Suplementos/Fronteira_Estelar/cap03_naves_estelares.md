...
| **Motor FTL** | 1 | Permite viagem interestelar. 3 Cargas de Combustível FTL por padrão (Cap. 4). Sem Motor FTL, a nave só opera em sistema local. |
...
| **Sistema de Suporte de Vida Avançado** | 1 | Dobra o tempo de Suprimentos (Cap. 4). Tripulação resiste a descompressão por 2 rodadas extras. |
