...
**Armadas:** Iniciativa fixa 5. São previsíveis. Suas ações são Telegrafadas (BTV [Cap. 4](../../Livro/cap04_mechas_kaijus_colossais.md)).
...
| Ação | Efeito |
|---|---|
| **Disparar** | Ataque normal com as armas da nave. Usa o atributo **Armamento** ([Cap. 3](cap03_naves_estelares.md)). |
...
| **Disparar Torpedos** | Ataque especial com Torpedos [Anti-Nau] ou [Anti-Armada]. Gasta 1–2 Cargas ([Cap. 4](cap04_desgaste_estelar.md)). Ganho em faixa Curta. |
...
| **Reparo de Emergência** | Rápida. O Engenheiro repara 1 ponto de Integridade Estrutural ([Cap. 4](cap04_desgaste_estelar.md)). Pode ser usada 1×/rodada. |
...
**Ação Exclusiva — Guerra Eletrônica:** O Oficial pode usar sua ação para tentar Hackeamento de Sistemas ([Cap. 1](cap01_escalas_no_vacuo.md)) contra qualquer nave em alcance Longo ou menor. OU pode transmitir informação tática (+1 no próximo teste de qualquer aliado à distância de comunicação).
...
2. **Operativos** não podem afetar a Nau à distância (exceções do [Cap. 1](cap01_escalas_no_vacuo.md) aplicam: Torpedos, Hackeamento, Pontos Fracos).
