...
**Armadas:** Iniciativa fixa 5. São previsíveis. Suas ações são Telegrafadas (BTV [Cap. 4](#cap04_professores_npcs/cap04_professores_npcs)).
...
| Ação | Efeito |
|---|---|
| **Disparar** | Ataque normal com as armas da nave. Usa o atributo **Armamento** ([Cap. 3](#cap03_as_casas/cap03_as_casas)). |
...
| **Disparar Torpedos** | Ataque especial com Torpedos [Anti-Nau] ou [Anti-Armada]. Gasta 1–2 Cargas ([Cap. 4](#cap04_professores_npcs/cap04_professores_npcs)). Ganho em faixa Curta. |
...
| **Reparo de Emergência** | Rápida. O Engenheiro repara 1 ponto de Integridade Estrutural ([Cap. 4](#cap04_professores_npcs/cap04_professores_npcs)). Pode ser usada 1×/rodada. |
...
**Ação Exclusiva — Guerra Eletrônica:** O Oficial pode usar sua ação para tentar Hackeamento de Sistemas ([Cap. 1](#cap01_criacao_personagem/cap01_criacao_personagem)) contra qualquer nave em alcance Longo ou menor. OU pode transmitir informação tática (+1 no próximo teste de qualquer aliado à distância de comunicação).
...
> 🚀 Versões estelares das 5 Formações de Tropa (BTV [Cap. 2](#cap02_combate_espacial/cap02_combate_espacial)).
...
2. **Operativos** não podem afetar a Nau à distância (exceções do [Cap. 1](#cap01_criacao_personagem/cap01_criacao_personagem) aplicam: Torpedos, Hackeamento, Pontos Fracos).
...
Cada camada roda na **mesma iniciativa** — corte entre uma e outra a cada turno para manter tensão. Use a Regra de Três Momentos (BTV [Cap. 7](#cap07_mundo_ao_redor/cap07_mundo_ao_redor)) para estruturar a batalha.
